...
void crossProduct(float *u, float *v, float *s);
...
TexData storeTex(float y, float y1, float y2, float *data1, float *data2);
int displayTexture(GzDisplay	*display, GzRender *render);